...
import (
	...
	"github.com/lucasti79/bgw4-put-patch-delete/tests/products/mocks"
...
func TestProductsHandler_Get(t *testing.T) {
	...
	t.Run("should return status 200 and a list of products with testify mock", func(t *testing.T) {
		// given (dado)
		storage := mocks.ProductsRepositoryMock{}
		hd := handlers.NewProductsHandler(&storage)
		expectedCode := http.StatusOK
...
func TestProductsHandlerMock_Save(t *testing.T) {
	t.Run("should return status 200 and a product", func(t *testing.T) {
		// given
		storage := mocks.ProductsRepositoryMock{}
		hd := handlers.NewProductsHandler(&storage)
